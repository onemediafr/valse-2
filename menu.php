...
<ul class="base col-lg-2 col-md-12 col-sm-12 col-xs-12" id="menu-accordeon">
        <li class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
          ...
          <li class="col-lg-12 col-md-6 col-sm-6 col-xs-12"><a href="maries.php" style="cursor:default;" id="menu">Mariés</a>
<!--
            <ul>
...
<!--
         <li class="col-lg-12 col-md-6 col-sm-6 col-xs-12"><a id="menu" href="valse.php">La Valse Blanche</a>
        </li>
-->
         <li class="hidden-lg col-md-6 col-sm-6 col-xs-12"><a id="menu" href="contact.php">Newsletter</a>
        </li>
