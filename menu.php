...
<ul class="base col-lg-2 col-md-12 col-sm-12 col-xs-12" id="menu-accordeon">
    ...
    <li class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
        <a href="maries.php" style="cursor:default;" id="menu">Mariés</a>
    </li>
    <li class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
        <a href="homme.php" style="cursor:default;" id="menu">Hommes</a>
    </li>
    <li class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
        <a href="femmes.php" style="cursor:default;" id="menu">Femmes</a>
    </li>
    <li class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
        <a href="enfant.php" style="cursor:default;" id="menu">Enfants</a>
    </li>
    <li class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
        <a id="menu" href="accessoires.php">Accessoires</a>
    </li>
    <li class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
        <a id="menu" href="contact.php">Contact</a>
    </li>
    <li class="hidden-lg col-md-6 col-sm-6 col-xs-12">
        <a id="menu" href="contact.php">Newsletter</a>
    </li>
    <li class="col-lg-12 hidden-md hidden-sm hidden-xs">
        <a style="cursor:default;" id="menu">Newsletter</a>
        <ul>
            <li>
